...
void main() {
  ...
  group('Premium Plan Limits', () {
    ...
    test(
      'should create 10 programs without error (exceeds Basic limit of 5)',
      () async {
    ...
    test(
      'should create 20 Classic sessions in one program (exceeds Basic limit of 10)',
      () async {
        ...
        expect(
          createdProgram.sessions.every((Session s) => s is ClassicSession),
          isTrue,
        );
      },
    );
    ...
    test(
      'should create 20 AMRAP sessions in one program (exceeds Basic limit of 10)',
      () async {
    ...
    test(
      'should create 20 EMOM sessions in one program (exceeds Basic limit of 10)',
      () async {
    ...
    test(
      'should create 20 HIIT sessions in one program (exceeds Basic limit of 10)',
      () async {
    ...
    test(
      'should create Classic session with 30 exercises (exceeds Basic limit of 15)',
      () async {
    ...
    test(
      'should create AMRAP session with 30 exercises (exceeds Basic limit of 15)',
      () async {
    ...
    test(
      'should create EMOM session with 30 exercises (exceeds Basic limit of 15)',
      () async {
    ...
    test(
      'should create HIIT session with 30 exercises (exceeds Basic limit of 15)',
      () async {
    ...
    test(
      'should create program with 50 mixed sessions (realistic Premium usage)',
      () async {
    ...
    test(
      'should create session with 50 exercises (realistic Premium usage)',
      () async {
    ...
    test(
      'should create multiple complex programs without limits (complete Premium scenario)',
      () async {
    ...
    test(
      'should never throw LIMIT_EXCEEDED errors with Premium plan',
      () async {
        ...
        final Program createdProgram1 = await ProgramsService.createFullProgram(
          program1,
        );
        expect(
          (createdProgram1.sessions.first as ClassicSession).exercises.length,
          equals(20),
        );

        final Program createdProgram2 = await ProgramsService.createFullProgram(
          program2,
        );
