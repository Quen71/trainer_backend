#!/usr/bin/env python3
"""
Restaurer les fichiers services/ sélectionnés depuis le cache Cursor
"""
import json
...
print("=" * 100)
print("🔄 RESTAURATION DES FICHIERS SERVICES MODIFIÉS")
print("=" * 100)
print()
