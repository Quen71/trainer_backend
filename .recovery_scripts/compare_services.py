#!/usr/bin/env python3
"""
Comparer les fichiers services/ récupérés avec les versions actuelles
"""
import json
...
services_file = Path('/Users/quentinlebreton/git/trainer_backend/.recovery_scripts/services_ready_to_restore.json')
with open(services_file, 'r', encoding='utf-8') as f:
    recovered = json.load(f)

# Dossier racine
base_dir = Path('/Users/quentinlebreton/git/trainer_backend/lib/services')

print("=" * 100)
print("🔍 COMPARAISON DES FICHIERS SERVICES RÉCUPÉRÉS AVEC LES VERSIONS ACTUELLES")
print("=" * 100)
print()
...
for rel_path in sorted(recovered.keys()):
    ...
    print(f"\n[{count}/{total_files}] 📄 lib/services/{rel_path}")
    print("-" * 100)
...
print("\n" + "=" * 100)
print("📊 RÉSUMÉ FINAL - lib/services/")
print("=" * 100)
...
restore_file = Path('/Users/quentinlebreton/git/trainer_backend/.recovery_scripts/services_restore_plan.json')
