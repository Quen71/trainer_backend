-- This migration adds the program name to the session log objects returned by
-- the `create_session_log` and `get_user_sessions_logs` RPC functions.

-- Update create_session_log
