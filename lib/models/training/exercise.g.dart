...
abstract class _$ClassicExerciseCWProxy {
  ClassicExercise id(int id);

  ClassicExercise exerciseId(int exerciseId);
...
class _$ClassicExerciseCWProxyImpl implements _$ClassicExerciseCWProxy {
  ...
  ClassicExercise call({
    ...
    Object? orderInSession = const $CopyWithPlaceholder(),
    Object? name = const $CopyWithPlaceholder(),
    Object? templateParameters = const $CopyWithPlaceholder(),
    ...
    return ClassicExercise(
      ...
      objectiveParameters: objectiveParameters == const $CopyWithPlaceholder()
          ? _value.objectiveParameters
          // ignore: cast_nullable_to_non_nullable
          : objectiveParameters as ClassicExerciseParameters?,
    );
  }
}
...
abstract class _$AmrapExerciseCWProxy {
  AmrapExercise id(int id);

  AmrapExercise exerciseId(int exerciseId);

  AmrapExercise orderInSession(int orderInSession);

  AmrapExercise name(String name);
  ...
  AmrapExercise call({
    ...
    return AmrapExercise(
      ...
      objectiveParameters: objectiveParameters == const $CopyWithPlaceholder()
          ? _value.objectiveParameters
          // ignore: cast_nullable_to_non_nullable
          : objectiveParameters as AmrapExerciseParameters?,
    );
  }
}
...
abstract class _$EmomExerciseCWProxy {
  EmomExercise id(int id);

  EmomExercise exerciseId(int exerciseId);

  EmomExercise orderInSession(int orderInSession);

  EmomExercise name(String name);
  ...
  EmomExercise call({
    ...
    int orderInSession,
    String name,
    EmomExerciseParameters templateParameters,
  ...
  EmomExercise call({
    ...
    return EmomExercise(
      ...
      objectiveParameters: objectiveParameters == const $CopyWithPlaceholder()
          ? _value.objectiveParameters
          // ignore: cast_nullable_to_non_nullable
          : objectiveParameters as EmomExerciseParameters?,
    );
  }
}
...
abstract class _$HiitExerciseCWProxy {
  HiitExercise id(int id);

  HiitExercise exerciseId(int exerciseId);

  HiitExercise orderInSession(int orderInSession);

  HiitExercise name(String name);
  ...
  HiitExercise call({
    ...
    int orderInSession,
    String name,
    HiitExerciseParameters templateParameters,
  ...
  HiitExercise call({
    ...
    return HiitExercise(
      ...
      objectiveParameters: objectiveParameters == const $CopyWithPlaceholder()
          ? _value.objectiveParameters
          // ignore: cast_nullable_to_non_nullable
          : objectiveParameters as HiitExerciseParameters?,
    );
  }
}
...
ClassicExercise _$ClassicExerciseFromJson(Map<String, dynamic> json) =>
    ClassicExercise(
...
Map<String, dynamic> _$ClassicExerciseToJson(ClassicExercise instance) =>
    <String, dynamic>{
      ...
      'order_in_session': instance.orderInSession,
      'name': instance.name,
      'parameters': instance.templateParameters.toJson(),
      'progression': _objectiveToProgression(instance.objectiveParameters),
    };

AmrapExercise _$AmrapExerciseFromJson(Map<String, dynamic> json) =>
    AmrapExercise(
      id: (json['id'] as num).toInt(),
      exerciseId: (json['exercise_id'] as num).toInt(),
      orderInSession: (json['order_in_session'] as num).toInt(),
...
Map<String, dynamic> _$AmrapExerciseToJson(AmrapExercise instance) =>
    <String, dynamic>{
      ...
      'name': instance.name,
      'parameters': instance.templateParameters.toJson(),
      'progression': _amrapObjectiveToProgression(instance.objectiveParameters),
    };
...
Map<String, dynamic> _$EmomExerciseToJson(EmomExercise instance) =>
    <String, dynamic>{
      ...
      'name': instance.name,
      'parameters': instance.templateParameters.toJson(),
      'progression': _emomObjectiveToProgression(instance.objectiveParameters),
    };
...
Map<String, dynamic> _$HiitExerciseToJson(HiitExercise instance) =>
    <String, dynamic>{
      ...
      'name': instance.name,
      'parameters': instance.templateParameters.toJson(),
      'progression': _hiitObjectiveToProgression(instance.objectiveParameters),
    };
